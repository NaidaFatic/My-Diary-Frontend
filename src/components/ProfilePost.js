                                                    ...
                                                    <div className="md:ml-5" style={{ width: '-webkit-fill-available' }}>
                                                        ...
                                                        <div className="post-comment flex">
                                                            <div className="text-center">
                                                                ...
                                                                {props.post.likes.length >= 0 && <small className="text-gray-500">{props.post.likes.length}</small>}
                                                            </div>
                                                            <div className="text-center">
                                                                <IconMessage2 className={isComment ? 'comment' : 'uncomment'} onClick={showComment} />
                                                                {comment.length >= 0 && <small className="text-gray-500">{comment.length}</small>}
                                                            </div>
                                                        </div>
